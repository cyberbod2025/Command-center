...
- Cada frente y cada herramienta de soporte (incluido este Command Center) tiene su propio `.git` independiente.
...
- **No almacenar claves, tokens, archivos `.env`, expedientes ni datos sensibles** en este repositorio ni en ningún documento del Command Center.
