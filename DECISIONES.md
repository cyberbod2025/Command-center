...
- **Proyecto:** Proyecto Horizonte (CodeBrain)
- **Fecha:** 2026-07-31
...
- **Evidencia:** módulos 6–8 aplicados y verificados: [PR #6](https://github.com/cyberbod2025/NUEVO-HORIZONTE/pull/6) (`c610946`), [PR #7](https://github.com/cyberbod2025/NUEVO-HORIZONTE/pull/7) (`697410f`) y [PR #8](https://github.com/cyberbod2025/NUEVO-HORIZONTE/pull/8) (`1fb416f`); faltan módulos 9–12.
- **Estado:** `aprobada` — en ejecución, con evidencia acumulada rama por rama.
...
- **Estado:** `retirada` — Hugo confirmó 2026-07-31 que el proyecto Supabase real de SASE Zero vive en **otra cuenta**, no en la conectada a este agente. `SASE-Light` no es el proyecto correcto; aplicar este fix habría introducido una desalineación nueva. No se ejecuta. Ver R-11 actualizado en `RIESGOS.md`. Pendiente real: acceso o credenciales verificables de la cuenta correcta.
...
- **Riesgos:** Confundir una simulación JS con un servidor HTTP real o romper la cadena de prerrequisitos. Mitigación: restricciones explícitas en ADR/retos, pruebas de la secuencia 16→17→18 y `lessonsV2.ts` al 100 % de cobertura.
- **Responsable:** Hugo + Claude Code
...
- **Riesgos:** Que un estudiante o una sesión futura confunda esta simulación con una conexión Supabase real y configurada. Mitigación: nota explícita de alcance en el ADR 0004 y en `docs/backlog.md` aclarando que el contenido es curricular, no infraestructura.
- **Responsable:** Hugo + Claude Code
